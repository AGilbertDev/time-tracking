...
| 17  | 2026-07-30 | Row simplification, the words total          | yes          | no              | [spec](specs/planning/row-simplification-words-total.md), [design](specs/planning/row-simplification-words-total-design.md) | [#34](https://github.com/AGilbertDev/time-tracking/pull/34) |
